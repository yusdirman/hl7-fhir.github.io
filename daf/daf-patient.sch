...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:address/f:postalCode">
      <sch:assert test="f:matches(issued,[0-9]{5}(-[0-9]{4}){0,1} )">(Zip or Postal Code) SHALL be formatted as 99999[-9999] for US Zip or ZIP +4 codes or as A9A9A9 for Canadian postal codes.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
