...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticOrder">
      ...
      <sch:assert test="count(f:orderer) &gt;= 1">orderer: minimum cardinality of 'orderer' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:extension</sch:title>
    <sch:rule context="f:DiagnosticOrder/f:extension">
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:identifier</sch:title>
    <sch:rule context="f:DiagnosticOrder/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:event/f:description</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:event/f:description/f:coding</sch:title>
  ...
  <sch:pattern>
    <sch:title>DiagnosticOrder.event.dateTime</sch:title>
    <sch:rule context="f:DiagnosticOrder/f:event/f:dateTime">
      <sch:assert test="f:matches(dateTime,/\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)/)">Datetime must be at least to day.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:item/f:code</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:DiagnosticOrder/f:item/f:code/f:coding</sch:title>
