...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/uslab-specimenrejectreason']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/uslab-specimenrejectreason': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/uslab-observationkind']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/uslab-observationkind': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/uslab-observationkind']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/uslab-observationkind': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:valueRange</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:valueRange/f:low</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:valueRange/f:high</sch:title>
