...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'certainty']) &gt;= 1">extension with URL = 'certainty': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'certainty']) &lt;= 1">extension with URL = 'certainty': maximum cardinality of 'extension' is 1</sch:assert>
