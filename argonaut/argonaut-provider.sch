...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:practitionerRole) &gt;= 1">practitionerRole: minimum cardinality of 'practitionerRole' is 1</sch:assert>
      <sch:assert test="count(f:practitionerRole) &lt;= 1">practitionerRole: maximum cardinality of 'practitionerRole' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:telecom">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/us-core-direct']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/us-core-direct': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:practitionerRole</sch:title>
    <sch:rule context="f:Practitioner/f:practitionerRole">
      <sch:assert test="count(f:organization) &gt;= 1">organization: minimum cardinality of 'organization' is 1</sch:assert>
      <sch:assert test="count(f:period) &lt;= 0">period: maximum cardinality of 'period' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Practitioner/f:practitionerRole/f:organization</sch:title>
  ...
  <sch:pattern>
    <sch:title>Practitioner.practitionerRole.organization.telecom</sch:title>
    <sch:rule context="f:Practitioner/f:practitionerRole/f:organization/f:telecom">
      <sch:assert test="count(f:use[@value='home']) = 0">The telecom of an organization can never be of use 'home' (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.practitionerRole.organization.address</sch:title>
    <sch:rule context="f:Practitioner/f:practitionerRole/f:organization/f:address">
      <sch:assert test="count(f:use[@value='home']) = 0">An address of an organization can never be of use 'home' (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Practitioner/f:practitionerRole/f:organization/f:contact</sch:title>
    <sch:rule context="f:Practitioner/f:practitionerRole/f:organization/f:contact">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:practitionerRole/f:specialty</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:practitionerRole/f:period</sch:title>
