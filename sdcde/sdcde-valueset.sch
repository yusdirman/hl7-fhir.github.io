...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ValueSet">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/valueset-effectiveDate']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/valueset-effectiveDate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/valueset-expirationDate']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/valueset-expirationDate': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ValueSet/f:expansion/f:contains">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/valueset-definition']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/valueset-definition': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/valueset-systemName']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/valueset-systemName': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/valueset-systemName']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/valueset-systemName': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
